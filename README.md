...
2. 🟡 **Medium (`medium_toxic.json`)**: Tests profound obfuscated profanity against casual sarcastic expressions. *Grader constraint: Heavy mathematical penalty applied via a false negative/positive precision matrix.*
